...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('arpitkumarsingh1205@gmail.com')
        setHasCopied(true);
        setTimeout(() => {
          setHasCopied(false);
        }, 2000);
        ...
        <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
            ...
            <div className="col-span-1 xl:row-span-4">
                <div className="grid-container">
                    ...
                    <div>
                        ...
                        <p className="grid-subtext">I&apos;m based in Mohali, Punjab, India and open to remote work worldwide.</p>
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-1xl md:text-xl font-medium text-gray_gradient text-white">arpitkumarsingh1205@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
